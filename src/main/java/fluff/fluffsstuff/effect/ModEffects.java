package fluff.fluffsstuff.effect;
...
public class ModEffects {
    ...
    {
        return Registry.register(Registries.STATUS_EFFECT, new Identifier(FluffsStuff.MOD_ID, name), effect);
    }
    public static void registerModEffects()
    {
        FluffsStuff.LOGGER.info("Registering Mod Effects for " + FluffsStuff.MOD_ID);
    }
}
